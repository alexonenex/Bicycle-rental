...
export default {
  ...
  data () {
    return {
      order: [
        // {isSelected: false, orderId: '20230515815', brand: '捷安特', name: 'MY 21', deposit: 200, number: 1, totalPrice: 200, stock: 12, store: '青羊区非遗博览园店' , url: 'src/assets/images/bictest.jfif'},
        // {isSelected: false, orderId: '20230515815', brand: '捷安特', name: 'MY 22', deposit: 200, number: 1, totalPrice: 200, stock: 0, store: '青羊区非遗博览园店' , url: 'src/assets/images/bictest.jfif'},
        // {isSelected: false, orderId: '20230515815', brand: '捷安特', name: 'MY 23', deposit: 200, number: 1, totalPrice: 200, stock: 1, store: '青羊区非遗博览园店' , url: 'src/assets/images/bictest.jfif'}
      ]
    }
  },
  async mounted() {
