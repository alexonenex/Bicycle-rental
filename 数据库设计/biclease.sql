...
-- ----------------------------
INSERT INTO `bicycleinfo` VALUES ('1', '1', '1', '1', 'GIANT', 'SL 0', '公路车', 46, 'Propel Advanced SL 0', 'https://giant-img.oss-cn-shanghai.aliyuncs.com/bike/20220819/166087296229868.jpg', '全新的Propel的设计理念基于AeroSystem超低风阻管型技术打造。通过分析管型形状、角度以及接合点，作为一个整体的系统每一个组成部件都显得尤为关键。空力系统管型重新设计，灵动的线条和优化的椭圆截背管型以最大限度减少阻力。 专属空力套件，标配两款专属设计的水壶架以遵循我们对空气动力学设计的理念，以最大限度地减少空气阻力。整合的空力水壶经过UCI认证可正式参赛。');
INSERT INTO `bicycleinfo` VALUES ('10', '1', '1', '1', 'GIANT', 'Advanced 3', '山地车', 20, 'XTC Advanced 3', 'https://giant-img.oss-cn-shanghai.aliyuncs.com/bike/20230116/167385075637221.jpg', '车架组专为100毫米前叉而设计，采用特定的复合叠层方案手工制作，该方案会根据车架尺寸而变化，以创造最佳的刚度重量比和恰到好处的垂直顺应性。它具有更宽的Boost轮毂间距，可提高车轮刚性并增加了轮胎的间隙，以及许多其他功能，几乎可让您在任何类型的地形上发挥其卓越性能。');
...
INSERT INTO `bicycleinfo` VALUES ('13', '1', '1', '1', 'GIANT', 'JR 2', '山地车', 5, 'Fastroad 24 JR 2', 'https://giant-img.oss-cn-shanghai.aliyuncs.com/bike/20220908/166260013675672.jpg', 'GIANT ALUXX青少年铝合金车架\n专为青少年设计，符合青少年公路车骑行几何，\n铝合金车架拥有轻量化结构，以及值得信赖的强度与刚性。\n');
INSERT INTO `bicycleinfo` VALUES ('14', '2', '1', '1', 'GIANT', 'JR 1', '山地车', 3, 'Fastroad 24 JR 1', 'https://giant-img.oss-cn-shanghai.aliyuncs.com/bike/20220908/166259772374492.jpg', 'GIANT ALUXX青少年铝合金车架\n专为青少年设计，符合青少年公路车骑行几何，\n铝合金车架拥有轻量化结构，以及值得信赖的强度与刚性。\n');
INSERT INTO `bicycleinfo` VALUES ('15', '1', '1', '1', 'GIANT', 'ATX 610 24', '山地车', 8, 'ATX 610 24', 'https://giant-img.oss-cn-shanghai.aliyuncs.com/bike/20220302/164620028541391.jpg', 'GIANT ALUXX轻量化铝合金技术打造， 坚固耐用的车架能够达到长久的陪伴。 专为青少年设计的车架，符合青少年的骑 乘几何。转把方便青少年使用，变速快速 精准。专用青少年坐垫更加适合青少年骑 行姿势，在单车上挥洒汗水。');
INSERT INTO `bicycleinfo` VALUES ('16', '1', '1', '1', 'GIANT', 'ATX 20-S', '山地车', 2, 'ATX 20-S', 'https://giant-img.oss-cn-shanghai.aliyuncs.com/bike/20220311/164695784220844.jpg', '突破自我经典重塑\n专为青少年定制的轻量化铝合金车架,强度与重量\n比进一步优化,同时采用传统管件成型与热处理工艺,保证骑行品质\n');
INSERT INTO `bicycleinfo` VALUES ('2', '2', '2', '2', 'GIANT', 'SL 1', '公路车', 20, 'Propel Advanced SL 1', 'https://giant-img.oss-cn-shanghai.aliyuncs.com/bike/20230519/168445705542796.jpg', '仅需一个4号内六角即可完成把立的更换以及调节垫片和车把。 车首部分经过完全重新设计，设计全新专属D型OverDrive Aero舵管，以及采用创新的Contact Aero车把和把立。 Contact Aero把立将所有线管均压入把立下方，更换把立无需重新走线，使更换部件更为容易，复杂度更低、契合度更高。 Contact Aero车把，整合式的外观拥有±10°可调节的车把角度，经过人体工学优化空力有更好的Fitting适应性。');
INSERT INTO `bicycleinfo` VALUES ('3', '1', '3', '1', 'GIANT', 'Pro 0 Di', '公路车', 10, 'Propel Advanced Pro 0 Di', 'https://giant-img.oss-cn-shanghai.aliyuncs.com/bike/20220822/166113373956160.jpg', '全新的Propel的设计理念基于AeroSystem超低风阻管型技术打造。\r\n\r\n通过分析管型形状、角度以及接合点，\r\n\r\n作为一个整体的系统每一个组成部件都显得尤为关键。\r\n\r\n空力系统管型重新设计，灵动的线条和优化的椭圆截背管型以最大限度减少阻力。\r\n\r\n专属空力套件，标配两款专属设计的水壶架以遵循我们对空气动力学设计的理念，\r\n\r\n以最大限度地减少空气阻力。整合的空力水壶经过UCI认证可正式参赛。');
INSERT INTO `bicycleinfo` VALUES ('4', '2', '2', '1', 'GIANT', 'Espoir 24', '公路车', 3, 'TCX Espoir 24', 'https://giant-img.oss-cn-shanghai.aliyuncs.com/bike/20220907/166251826393695.jpg', '专为青少年设计的压缩车架结构，具有较低的跨高，\r\n\r\n让小骑手拥有信心和控制力，车架内走线设计，整车简洁美观。\r\n\r\n');
INSERT INTO `bicycleinfo` VALUES ('5', '1', '1', '1', 'GIANT', 'SL Disc Team', '公路车', 1, 'TCR Advanced SL Disc Team', 'https://giant-img.oss-cn-shanghai.aliyuncs.com/bike/20230402/168040467419876.jpg', 'TCR Advanced SL Disc以更轻量的车架提升爬坡效率，\r\n\r\n更强的踩踏刚性与更具空气力学的整合式设计，\r\n\r\n让您的竞赛表现提升至全新境界。\r\n\r\n油压碟刹在晴雨天气均能保持一致的制动力，\r\n\r\n高刚性前叉让您在下坡和压弯时自信操控。');
INSERT INTO `bicycleinfo` VALUES ('6', '3', '1', '1', 'GIANT', 'Disc 3', '公路车', 1, 'TCR Advanced Disc 3', 'https://giant-img.oss-cn-shanghai.aliyuncs.com/bike/20230116/167384732130805.png', 'TCR Advanced Disc 3以更轻量的车架 提升爬坡效率，更强的踩踏刚性与更具空 气力学的整合式设计，让您的竞赛表现提 升至全新境界。油压碟刹在晴雨天气均能 保持一致的制动力，高刚性前叉让您在下 坡和压弯时自信操控。');
...
-- Records of carousel
-- ----------------------------
INSERT INTO `carousel` VALUES ('1', '丽以芙Liv新款 Aimez SL 2公路自行车', 'https://giant-img.oss-cn-shanghai.aliyuncs.com/bike/20220819/166087296229868.jpg');
...
INSERT INTO `customer` VALUES ('20230603815X', '17345449129', '王狼', '男', 21, '51192320011216815X', '17345449129', '2605735186@qq.com', '四川省成都市青羊区文家场正街227号');
...
CREATE TABLE `leaseinfo`  (
  ...
  `l_duration` time NULL DEFAULT NULL COMMENT '租借时长',
...
INSERT INTO `platedata` VALUES ('24', '11', '山地车');
INSERT INTO `platedata` VALUES ('25', '10', '山地车');
...
INSERT INTO `platedata` VALUES ('8', '6', '推荐');
INSERT INTO `platedata` VALUES ('9', '9', '推荐');
